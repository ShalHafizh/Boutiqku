...
// barang
Route::get ('/Home',                        'App\Http\Controllers\BarangController@index')->middleware('guest');
...
// jenis barang
Route::get('/JenisBarang',                 	'App\Http\Controllers\JenisBarangController@Index')->middleware('guest');
...
//pemesanan
Route::get('/Pemesanan',                    'App\Http\Controllers\PemesananController@index')->middleware('guest');
//input pemesanan 
...
//Detail Pemesanan
Route::get('/DetailPemesanan',              'App\Http\Controllers\DetailPemesananController@index')->middleware('guest');
...
//User
Route::get('/User',            	 	        'App\Http\Controllers\UserController@index')->middleware('guest');
//input User 
...
//Warna
Route::get('/Warna',                    	'App\Http\Controllers\WarnaController@index')->middleware('guest');
//input Warna 
...
//Ukuran
Route::get('/Ukuran',                   	'App\Http\Controllers\UkuranController@index')->middleware('guest');
//input Ukuran 
...
//Kota
Route::get('/Kota',                 		'App\Http\Controllers\KotaController@index')->middleware('guest');
//input Kota 
...
//Role
Route::get('/Role',                 		'App\Http\Controllers\RoleController@index')->middleware('guest');
//input Role 
...
//Supplier
Route::get('/Supplier',                 	'App\Http\Controllers\SupplierController@index')->middleware('guest');
//input Supplier 
...
//Penerimaan
Route::get('/Penerimaan',                   'App\Http\Controllers\PenerimaanController@index')->middleware('guest');
//input Penerimaan 
...
Route::get('/DetailPenerimaan',             'App\Http\Controllers\DetailPenerimaanController@index')->middleware('guest');
...
//Pembayaran
Route::get('/Pembayaran',                   'App\Http\Controllers\PembayaranController@index')->middleware('guest');
//input Pembayaran 
...
//History Stock
Route::get('/HistoryStock',                 'App\Http\Controllers\HistoryStockController@index')->middleware('guest');
//input HistoryStock 
